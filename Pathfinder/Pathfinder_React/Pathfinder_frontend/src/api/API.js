...
fetch(`http://localhost:3000/post/selfprojects`, {     // ${api}/users/doLogin` this contains the address of the backend server.
        method: 'GET',
        headers: {
            ...headers,
...
fetch(`http://localhost:3000/bids/getbids`, {     // ${api}/users/doLogin` this contains the address of the backend server.
        method: 'GET',
        headers: {
            ...headers,
            'Content-Type': 'application/json'   //json data is passed from react to node.
...
fetch(`http://localhost:3000/post/openprojects`, {     // ${api}/users/doLogin` this contains the address of the backend server.
        method: 'GET',
        headers: {
            ...headers,
            'Content-Type': 'application/json'   //json data is passed from react to node.
...
fetch(`http://localhost:3000/profile/getprofileimage`, {     // ${api}/users/doLogin` this contains the address of the backend server.
        method: 'GET',
        headers: {
            ...headers,
            'Content-Type': 'application/json'   //json data is passed from react to node.
    ...
    fetch(`http://localhost:3000/profile/userdetails`, {     // ${api}/users/doLogin` this contains the address of the backend server.
            method: 'GET',
            headers: {
                ...headers,
                'Content-Type': 'application/json'   //json data is passed from react to node.
    ...
    fetch(`http://localhost:3000/post/projectdetails`, {     // ${api}/users/doLogin` this contains the address of the backend server.
            method: 'POST',
            headers: {
                ...headers,
                'Content-Type': 'application/json'   //json data is passed from react to node.
    ...
    fetch(`http://localhost:3000/bids/getBidData`, {     // ${api}/users/doLogin` this contains the address of the backend server.
            method: 'POST',
            headers: {
                ...headers,
                'Content-Type': 'application/json'   //json data is passed from react to node.
    ...
    export const AssignProject = (payload) =>    //payload contains the credentials of login.
        ...
        fetch(`${api}/account/addmoney`, {     // ${api}/users/doLogin` this contains the address of the backend server.
            method: 'POST',
            headers: {
                ...headers,
                'Content-Type': 'application/json'   //json data is passed from react to node.
        ...
        fetch(`${api}/account/paymoney`, {     // ${api}/users/doLogin` this contains the address of the backend server.
            method: 'POST',
            headers: {
                ...headers,
                'Content-Type': 'application/json'   //json data is passed from react to node.
        ...
        fetch(`${api}/account/deductmoney`, {     // ${api}/users/doLogin` this contains the address of the backend server.
            method: 'POST',
            headers: {
                ...headers,
                'Content-Type': 'application/json'   //json data is passed from react to node.
...
fetch(`http://localhost:3000/account/getBalance`, {     // ${api}/users/doLogin` this contains the address of the backend server.
        method: 'GET',
        headers: {
            ...headers,
            'Content-Type': 'application/json'   //json data is passed from react to node.
        ...
        fetch(`http://localhost:3000/post/particularprojects`, {     // ${api}/users/doLogin` this contains the address of the backend server.
                method: 'POST',
                headers: {
                    ...headers,
                    'Content-Type': 'application/json'   //json data is passed from react to node.
