     ...
     else
     {
      nodemailer.createTestAccount((err, account) => {
        ...
        const transporter = nodemailer.createTransport({
          ...
          port: 587,
          auth: {
              user: 't52vorupaxrwgvvq@ethereal.email',
              pass: 'UsSrM8TQkfzkYpjwMa'
          }
      });
    
        // setup email data with unicode symbols
        let mailOptions = {
            from: '"Fred Foo 👻" <foo@freelancer.com>', // sender address
            to: req.body.email, // list of receivers
            subject: 'Hired Freelancer', // Subject line
            text: 'Hello world?', // plain text body
            html: '<b>I am happy to say you that you have been hired by </b>'+req.session.email+"and would look to work with you to create great solution." // html body
        };
